...
import { getAll, addRecord, genNo } from '../db/index.js'
...
const submitted = ref(false) // only show errors after user tries to submit
...
async function submit() {
  ...
  await addRecord('purchase_orders', {
    orderNo:      no,
    productId:    p.id,
    productName:  p.name,
    spec:         p.spec,
  ...
  <div class="screen">
    ...
    <template v-if="done">
      ...
      <div class="success-wrap">
        <div class="success-icon" style="background:#E6F1FB;color:#185FA5">
        ...
        <div class="success-tag" style="background:#E6F1FB;color:#185FA5">
          采购单号：{{ doneNo }}
        </div>
        ...
        <div class="info-block" style="width:100%;margin-top:16px">
          <div class="info-row">
            ...
            <span class="info-val">{{ doneData.spec }}</span>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            <span class="info-key">发货方</span>
            <span class="info-val">{{ doneData.shipper }}</span>
          </div>
        </div>

        <button class="btn" style="background:#185FA5;color:#fff;margin-top:24px" @click="reset">
    ...
    <template v-else>
      ...
      <div class="body">
        ...
        <div class="section-header" style="background:#E6F1FB;color:#185FA5">
        ...
        <!-- Spec display (auto-filled, read-only) -->
        ...
        <button class="btn" style="background:#185FA5;color:#fff;margin-top:4px" @click="submit">
          <i class="ti ti-send" />提交采购单
        </button>
